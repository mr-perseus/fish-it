...
namespace Fishit.BusinessLayer.Testing
{
    public class FishingTripManagerTest
    {
        ...
        public async void GetAllCatches()
        {
            ...
            Response<FishingTrip> deletedCatchResponse =
                await _fishingTripManager.DeleteCatch(createdFishingTripResponse.Content,
                    createdFishingTripResponse.Content.Catches.Last());
        ...
        public async void GetFishingTrip()
        {
            Response<FishingTrip> createdFishingTripResponse =
                await _fishingTripManager.CreateFishingTrip(_fishingTrip);
            Response<FishingTrip> fishingTripAfterCreate =
                await _fishingTripManager.GetFishingTrip(createdFishingTripResponse.Content);
            Response<FishingTrip> deletedFishType =
                await _fishingTripManager.DeleteFishingTrip(createdFishingTripResponse.Content);
        ...
        {
            Response<FishType> createdFishTypeResponse = await _fishingTripManager.CreateFishType(_fishType);
            Response<FishType> fishTypeAfterCreate =
                await _fishingTripManager.GetFishType(createdFishTypeResponse.Content);
            Response<FishType> deletedFishType =
                await _fishingTripManager.DeleteFishType(createdFishTypeResponse.Content);
        ...
        public async void UpdateFishingTrip()
        {
            ...
            Response<FishingTrip> fishingTripAfterUpdate =
                await _fishingTripManager.UpdateFishingTrip(fishingTripBeforeUpdate.Content);
            ...
            Response<FishingTrip> deletedFishingtripResponse =
                await _fishingTripManager.DeleteFishingTrip(fishingTripAfterUpdate.Content);
            Assert.True(deletedFishingtripResponse.StatusCode == HttpStatusCode.OK);
        }
        ...
        public async void UpdateFishType()
        {
            ...
            Response<FishType> fishTypeAfterUpdate =
                await _fishingTripManager.UpdateFishType(fishTypeBeforeUpdate.Content);
            ...
            Response<FishType> deletedFishTypeResponse =
                await _fishingTripManager.DeleteFishType(fishTypeAfterUpdate.Content);
